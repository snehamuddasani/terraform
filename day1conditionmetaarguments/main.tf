variable "aws_region" {
  ...
  type        = string
  nullable    = false
  default     = "ap-south-2" #here we need to define either us-west-1 or eu-west-2 if i give other region will get error 
  validation {
    condition = var.aws_region == "ap-south-2" || var.aws_region == "ap-south-1"
